...
- [`318bb3a`](https://github.com/NovaShang/sldeditor/commit/318bb3a42d393d2b3e29aef6c30b076ba4f8230b) Thanks [@NovaShang](https://github.com/NovaShang)! - Runtime stage 1: `<OneLineViewer>` + data bindings.
  ...
  **Not a second renderer.** The viewer mounts the editor's own canvas layers
  over a _private_, non-persisted store (`createEditorStore()`, reached by the
...
- [`ed4240d`](https://github.com/NovaShang/sldeditor/commit/ed4240da847fff1cb2cecda70dc21820701e9cdb) Thanks [@NovaShang](https://github.com/NovaShang)! - Multi-line equipment names, draggable label blocks, and busduct symbols.
  ...
  **Labels can be dragged off their anchor.** New optional
  ...
  description clear of the wiring" means. Right-click → _Reset label position_
...
- [`6132084`](https://github.com/NovaShang/sldeditor/commit/61320841998751c601b6eb1b01e829d4e7b65be9) Thanks [@NovaShang](https://github.com/NovaShang)! - Recolour a whole selection from the contextual toolbar.
...
- [`ed4240d`](https://github.com/NovaShang/sldeditor/commit/ed4240da847fff1cb2cecda70dc21820701e9cdb) Thanks [@NovaShang](https://github.com/NovaShang)! - IEC ⇄ ANSI symbol standard, as a document setting.
  ...
  **Switching standards only changes the drawing.** A `LibraryVariant` carries
  ...
  model either way. The build script _enforces_ it: a variant whose frame does
...
- [`0594993`](https://github.com/NovaShang/sldeditor/commit/0594993e5bf2f085451aa4f6b6d001dca470992e) Thanks [@NovaShang](https://github.com/NovaShang)! - A document can define its own symbols, and the drawing tools collapse into one button.
...
- [`42734b0`](https://github.com/NovaShang/sldeditor/commit/42734b0c25909f3cdb0d284c94fea5f805c480eb) Thanks [@NovaShang](https://github.com/NovaShang)! - Free drawing gets colour, an ellipse tool, and real line styles.
...
- [`3eba53d`](https://github.com/NovaShang/sldeditor/commit/3eba53dd44f2696d160aca2b181b340a51cc8b7e) Thanks [@NovaShang](https://github.com/NovaShang)! - Fix DXF export producing files no CAD reader can open.
...
- [`9fba580`](https://github.com/NovaShang/sldeditor/commit/9fba5806a9913634a69abb4f5c7f7dd73bfe5f8c) Thanks [@NovaShang](https://github.com/NovaShang)! - Marquee selection now includes annotations, group moves carry them, and a group move finally translates manual wire waypoints.
...
- [`4f5b1a2`](https://github.com/NovaShang/sldeditor/commit/4f5b1a23b41ccbc560128bf7ad53f9b61b8696b8) Thanks [@NovaShang](https://github.com/NovaShang)! - Raise the view toolbar above host chrome so its Labels popover is usable.
...
- [`c673648`](https://github.com/NovaShang/sldeditor/commit/c673648dd0e0c264b2e80eba61da4f776b2a6737) Thanks [@NovaShang](https://github.com/NovaShang)! - Make element and wire **label type size adjustable per document**, and rebuild the label control so the current mode is actually legible.
...
- [`715f51e`](https://github.com/NovaShang/sldeditor/commit/715f51ee1a5e926582e05e24177e6276a3c8d961) Thanks [@NovaShang](https://github.com/NovaShang)! - Add a **luminaire / lighting-load** element, and make **protection-device ratings render on the canvas**.
